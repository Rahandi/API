...
class InstagramAPI:
    ...
    def login(self, force = False):
        if (not self.isLoggedIn or force):
            ...
            self.s.proxies = {"https" : "http://ITS-557603-f316c:579f6@proxy.its.ac.id:8080"}
    ...
    def getTotalUserFeed(self, usernameId, dicari, minTimestamp = None):
        user_feed = []
        next_max_id = ''
        while 1:
